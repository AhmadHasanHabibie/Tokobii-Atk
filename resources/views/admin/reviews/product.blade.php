        ...
        <p class="text-slate-500 mb-0"
           ...
           ">
            ...
            @if($product->reviews_count)
                <span class="d-inline-flex align-items-center gap-1 text-amber-500 fw-bold">
                    <svg width="15" height="15" fill="#f59e0b" stroke="#f59e0b" viewBox="0 0 24 24">
...
<div class="d-flex flex-column gap-3 mb-4">
    ...
    @forelse($reviews as $review)
        ...
        <div class="review-item-card p-4">
            ...
            {{-- Rating --}}
            <div class="review-rating mb-3 d-flex align-items-center gap-1">
                <div class="d-inline-flex align-items-center gap-1 text-amber-500">
                    @for($i = 1; $i <= 5; $i++)
                ...
                <span class="review-rating-number ms-1">
                    {{ $review->rating }}/5
                </span>
            </div>
