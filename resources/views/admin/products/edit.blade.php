...
@section('title', 'Edit Produk - Tokobii')
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h1 class="h3 fw-bold text-slate-900 mb-1" style="color: #0f172a;">Edit Produk</h1>
            <p class="text-slate-500 mb-0" style="font-size: 0.875rem;">Perbarui spesifikasi produk untuk <strong class="text-slate-800">{{ $product->name }}</strong>.</p>
        </div>
        <div>
    ...
    <div class="tokobii-card">
        <div class="tokobii-card-header">
            <h5 class="fw-bold mb-0 text-slate-900" style="font-size: 1rem;">Form Edit Produk</h5>
        </div>
        <div class="p-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" 
                                ...
                                required>
                            <option value="active" {{ old('status', $product->status) == 'active' ? 'selected' : '' }}>Aktif (Tampak di Toko)</option>
                            <option value="inactive" {{ old('status', $product->status) == 'inactive' ? 'selected' : '' }}>Tidak Aktif (Tersembunyi)</option>
                        </select>
                        @error('status')
                            <div class="text-danger mt-1" style="font-size: 0.8125rem;">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 pt-3 border-top border-slate-100 d-flex gap-2">
                        <button type="submit" class="btn btn-tokobii-primary" id="submitBtn">
                            ...
                            <span id="btnText">Perbarui Produk</span>
                        </button>
