...
@section('title', 'Edit Product - Tokobii')
...
<div class="container-fluid px-0">
    ...
    {{-- Page Header --}}
    <div class="mb-4">
        <h2 class="fw-bold mb-1 text-dark">Edit Product</h2>
        <p class="text-muted mb-0">Perbarui informasi produk <strong class="text-dark">{{ $product->name }}</strong>.</p>
    </div>

    {{-- Form Card --}}
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom py-3 px-4">
            <h5 class="fw-bold mb-0 text-dark">Formulir Edit Produk</h5>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" 
                                  ...
                                  aria-describedby="descHelp">{{ old('description', $product->description) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <small id="thumbHelp" class="text-muted d-block mt-1">Biarkan kosong jika tidak ingin mengubah thumbnail. Format: JPG, JPEG, PNG, WEBP (Max 2MB).</small>
                        @error('thumbnail')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" 
                            ...
                            <option value="active" {{ old('status', $product->status) == 'active' ? 'selected' : '' }}>Active (Tampil di Toko)</option>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Live image preview without page reload when new image selected
        ...
        if (productForm && submitBtn) {
            productForm.addEventListener('submit', function () {
                ...
                if (btnText) btnText.textContent = 'Memperbarui...';
            });
        }
    });
</script>
