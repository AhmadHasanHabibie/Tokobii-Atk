...
<style>
    /* =========================================
       Order Action Card Buttons
       Hanya styling, tidak mengubah logic/route
       ========================================= */
    ...
    .orders-detail-btn {
        ...
        box-shadow: 0 2px 5px rgba(37, 99, 235, 0.13);
        ...
        <div>
            ...
            <p class="text-slate-500 mb-0"
               style="font-size: 0.875rem;">
                Manage store orders, verify payments, and handle order pickups.
            </p>
            ...
            <div class="tokobii-card p-3 h-100">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <span class="text-slate-400 text-uppercase fw-bold d-block"
            ...
            <div class="tokobii-card p-3 h-100">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h4 class="fw-bold text-amber-500 mb-0 mt-1"
                            style="font-size: 1.35rem;">
            ...
            <div class="tokobii-card p-3 h-100">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h4 class="fw-bold text-emerald-600 mb-0 mt-1"
                            style="font-size: 1.35rem;">
            ...
            <div class="tokobii-card p-3 h-100">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h4 class="fw-bold text-blue-600 mb-0 mt-1"
                            style="font-size: 1.35rem;">
            ...
            <div class="tokobii-card p-3 h-100">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <h4 class="fw-bold text-rose-500 mb-0 mt-1"
                            style="font-size: 1.35rem;">
                            {{ number_format($rejectedOrders) }}
                        </h4>
        ...
        <form action="{{ route('admin.orders.index') }}"
            ...
            <div class="col-12 col-sm-6 col-md-2">
                ...
                <select name="status"
                    ...
                    <option value="ready_for_pickup"
                        {{ request('status') === 'ready_for_pickup' ? 'selected' : '' }}>
                        Ready for Pickup
                    </option>
            ...
            <div class="col-12 col-sm-6 col-md-2">
                ...
                <select name="sort"
                    ...
                    <option value="invoice_asc"
                        {{ request('sort') === 'invoice_asc' ? 'selected' : '' }}>
                        Invoice (A-Z)
                    </option>

                    <option value="total_desc"
                        {{ request('sort') === 'total_desc' ? 'selected' : '' }}>
                        Highest Total
                    </option>

                    <option value="total_asc"
                        {{ request('sort') === 'total_asc' ? 'selected' : '' }}>
                        Lowest Total
                    </option>
            ...
            <div class="col-12 col-md-2 d-flex gap-1">
                ...
                <button type="submit"
                        class="btn btn-tokobii-primary orders-filter-btn w-100"
                        id="filterBtn">
        ...
        @forelse($orders as $order)
            ...
            <tr>
                ...
                <td>
                    ...
                    <code class="text-blue-600 font-monospace fw-bold"
                ...
                <td>
                    ...
                    <span class="fw-semibold text-slate-900 d-block text-truncate"
                    ...
                    <span class="text-slate-400 d-block text-truncate font-monospace"
                          style="font-size: 0.75rem; max-width: 160px;">
                ...
                <td class="text-end">
                    ...
                    <a href="{{ route('admin.orders.show', $order) }}"
                       class="btn btn-sm orders-detail-btn">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (filterForm && filterBtn) {
            ...
            filterForm.addEventListener('submit', function () {
                ...
                if (filterBtnText) {
                    filterBtnText.textContent = 'Loading...';
                }
