...
@section('title', 'Tambah Category - Tokobii')
...
<div class="container-fluid px-0">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb bg-transparent p-0 mb-0 small">
            ...
            <li class="breadcrumb-item active text-dark fw-semibold" aria-current="page">Tambah Category</li>
        </ol>
    </nav>

    {{-- Page Header --}}
    <div class="mb-4">
        <h2 class="fw-bold mb-1 text-dark">Tambah Category Baru</h2>
        <p class="text-muted mb-0">Isi formulir di bawah ini untuk mengunggah dan mempublikasikan kategori produk baru.</p>
    </div>

    {{-- Form Card --}}
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom py-3 px-4">
            <h5 class="fw-bold mb-0 text-dark">Formulir Kategori</h5>
        </div>
        <div class="card-body p-4">

            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" id="categoryForm" novalidate>
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <small id="slugHelp" class="text-muted d-block mt-1">Slug URL dibuat secara otomatis berdasarkan nama kategori.</small>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <small id="thumbHelp" class="text-muted d-block mt-1">Format yang didukung: JPG, JPEG, PNG, WEBP (Ukuran maks: 2MB).</small>
                        @error('thumbnail')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="mt-3">
                            <span class="d-none small text-muted d-block mb-1" id="previewLabel">Live Preview Image:</span>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Live image preview without reload
