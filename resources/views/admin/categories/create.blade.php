...
@section('title', 'Tambah Kategori - Tokobii')
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h1 class="h3 fw-bold text-slate-900 mb-1" style="color: #0f172a;">Tambah Kategori Baru</h1>
            <p class="text-slate-500 mb-0" style="font-size: 0.875rem;">Buat taksonomi kategori baru untuk produk Tokobii.</p>
        </div>
        <div>
    ...
    <div class="tokobii-card">
        <div class="tokobii-card-header">
            <h5 class="fw-bold mb-0 text-slate-900" style="font-size: 1rem;">Form Kategori</h5>
        </div>
        <div class="p-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               autofocus 
                               required>
                        <span class="text-slate-400 d-block mt-1" style="font-size: 0.75rem;">Nama kategori unik (Maks 100 karakter).</span>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               readonly>
                        <span class="text-slate-400 d-block mt-1" style="font-size: 0.75rem;">Slug URL diformat secara otomatis.</span>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Jelaskan produk dalam kategori ini (opsional)...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="text-danger mt-1" style="font-size: 0.8125rem;">{{ $message }}</div>
                        @enderror
                    </div>
