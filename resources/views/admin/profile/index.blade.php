...
@section('title', 'Profil Administrator - Tokobii')
            ...
            <div>
                <nav aria-label="breadcrumb" class="mb-2">
                    <ol class="breadcrumb bg-transparent p-0 mb-0" style="font-size: 0.8125rem;">
                        ...
                        <li class="breadcrumb-item active text-slate-800 fw-semibold" aria-current="page">Profil Administrator</li>
                    </ol>
                </nav>
                <h1 class="h3 fw-bold text-slate-900 mb-1" style="color: #0f172a;">Profil Administrator</h1>
                <p class="text-slate-500 mb-0 small">Rincian akun dan hak akses pengelolaan sistem Tokobii.</p>
            </div>
            <a href="{{ route('admin.profile.edit') }}" class="btn btn-tokobii-primary btn-tokobii-sm">
        ...
        <div class="col-12 col-lg-7">
            <div class="tokobii-card p-4 p-md-5 h-100">
                <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom border-slate-100">
                    <div class="rounded-circle bg-blue-50 text-blue-600 fw-bold d-flex align-items-center justify-content-center flex-shrink-0" style="width: 56px; height: 56px; font-size: 1.25rem; background-color: #eff6ff; color: #2563eb;">
            ...
            <div class="tokobii-card p-4 p-md-5 h-100">
                <div class="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom border-slate-100">
                    ...
                    <div>
                        ...
                        <span class="text-slate-400 small">Autentikasi wajah Administrator</span>
                    </div>
                </div>
                ...
                <div class="bg-slate-50 rounded-3 p-3 p-sm-4 border border-slate-200">
                    <div class="mb-2">
                        ...
                        <span class="text-slate-500 small d-block mb-3" style="line-height: 1.5;">
                            Wajah Anda akan digunakan sebagai lapisan verifikasi biometrik tambahan saat login ke Dashboard Administrator Tokobii.
                        </span>
                    </div>
            ...
            <div class="modal-body p-4">
                ...
                <div class="position-relative mb-3 rounded-3 overflow-hidden bg-slate-950 shadow-inner" style="height: 260px;">
                    ...
                    <div id="faceOvalGuide" class="position-absolute top-50 start-50 translate-middle pointer-events-none" 
                         style="width: 150px; height: 190px; border: 3px dashed rgba(59, 130, 246, 0.7); border-radius: 50%; box-shadow: 0 0 0 9999px rgba(15, 23, 42, 0.55); pointer-events: none; transition: border-color 0.25s ease, box-shadow 0.25s ease;">
                    </div>
                </div>
                ...
                <div class="text-center mb-2">
                    ...
                    <span id="faceStatus" class="tokobii-badge bg-blue-50 text-blue-700 border-blue-200 mb-1">
            ...
            <div class="modal-header border-bottom border-slate-100 p-4">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        ...
                        <small class="text-slate-400">Konfirmasi Keamanan Administrator</small>
                    </div>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
            </div>
            
            <form method="POST" action="{{ route('admin.profile.face-verification.disable') }}">
                @csrf
                <div class="modal-body p-4">
                    <p class="text-slate-600 small mb-3">
                        Apakah Anda yakin ingin menonaktifkan <strong>Verifikasi Wajah (Face Verification)</strong>? Login Administrator berikutnya hanya akan memerlukan email dan kata sandi.
                    </p>

                    <div class="mb-3">
                        <label for="disable_face_password" class="form-label">Kata Sandi Akun <span class="text-rose-600">*</span></label>
                        <input type="password"
                               id="disable_face_password"
                               name="password"
                               class="form-control tokobii-input"
                               placeholder="Masukkan kata sandi untuk konfirmasi"
                               required>
