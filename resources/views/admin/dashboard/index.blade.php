        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <div>
                <div class="d-flex align-items-center gap-2 mb-1">
                    <span class="tokobii-badge tokobii-badge-info">Panel Administrator</span>
                    <span class="text-slate-400 small">{{ now()->translatedFormat('l, d F Y') }}</span>
                </div>
                <h1 class="h3 fw-bold text-slate-900 mb-1" style="color: #0f172a;">Dashboard Administrator</h1>
                <p class="text-slate-500 mb-0 small">
                    Selamat datang kembali, <strong class="text-slate-800">{{ Auth::user()->name }}</strong>. Berikut adalah ringkasan operasional Tokobii.
                </p>
            </div>
            ...
            <div class="dashboard-header-actions">
                {{-- Pesanan & Pengambilan --}}
                <a href="{{ route('admin.orders.index') }}" class="dashboard-action-card">
                ...
                {{-- Scan QR --}}
                <a href="{{ route('admin.orders.scan') }}" class="dashboard-action-card">
                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
