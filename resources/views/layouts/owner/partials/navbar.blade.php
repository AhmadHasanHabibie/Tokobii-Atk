<header class="tokobii-navbar sticky-top d-flex align-items-center justify-content-between px-3 px-md-4 px-xl-5 bg-white border-bottom border-slate-200" style="height: 64px; z-index: 1020;">
    ...
    <div class="d-flex align-items-center gap-3">
        <button class="btn btn-tokobii-secondary d-lg-none p-2 border-0 shadow-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#ownerSidebarMenu" aria-controls="ownerSidebarMenu" aria-label="Menu Utama">
        ...
        <div class="d-none d-sm-flex align-items-center gap-2">
            ...
            <span class="text-slate-500 small">Ringkasan Eksekutif & Kinerja Toko</span>
        </div>
    </div>
    ...
    <div class="d-flex align-items-center gap-3">
        <div class="dropdown">
            <button class="btn btn-tokobii-secondary d-flex align-items-center gap-2 p-1.5 pe-3 border rounded-pill shadow-none" type="button" id="ownerNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="rounded-circle bg-emerald-100 text-emerald-700 fw-bold d-flex align-items-center justify-content-center" style="width: 32px; height: 32px; font-size: 0.8125rem; background-color: #ecfdf5; color: #047857;">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg border border-slate-200 rounded-3 p-2 mt-2" aria-labelledby="ownerNavbarDropdown" style="min-width: 220px;">
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 rounded-2 py-2 text-slate-700 hover-bg-slate-50" href="{{ route('owner.profile.index') }}" style="font-size: 0.8125rem;">
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-2 rounded-2 py-2 text-slate-700 hover-bg-slate-50" href="{{ route('owner.profile.edit') }}" style="font-size: 0.8125rem;">
                        <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="text-slate-400">
