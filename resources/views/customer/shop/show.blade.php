...
<div class="container-fluid px-0">
    ...
    <div class="tokobii-card p-4 p-md-5 mb-4 shadow-sm">
                ...
                <div class="bg-slate-50 rounded-4 p-4 border border-slate-200 position-relative d-flex align-items-center justify-content-center overflow-hidden" style="min-height: 360px;">
                    @if($product->thumbnail)
                        <img src="{{ asset('storage/' . $product->thumbnail) }}" 
                             ...
                             class="img-fluid object-fit-contain transition" 
                             style="max-height: 330px; transition: transform 0.3s ease;">
                    @else
                ...
                <div class="pt-4 border-top border-slate-100">
                    ...
                    @else
                        <div class="p-3.5 bg-rose-50 text-rose-800 rounded-3 border border-rose-200 small fw-semibold text-center">
                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="me-1" style="display:inline;">
    ...
    <div class="tokobii-card p-4 p-md-5 mb-4 shadow-sm" id="reviews-section">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-slate-100">
            <div>
                ...
                <p class="text-slate-500 small mb-0">Ulasan dan rating asli dari para pembeli yang telah memesan produk ini.</p>
            </div>
        ...
        {{-- Review Rating Overview & Breakdown Card --}}
        ...
        <div class="d-flex flex-column gap-3">
            @forelse($reviews as $review)
                <div class="p-3.5 bg-slate-50 rounded-3 border border-slate-200 transition hover-shadow-sm">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="d-flex align-items-center gap-2.5">
                            <div class="rounded-circle bg-blue-100 text-blue-700 fw-bold d-flex align-items-center justify-content-center shadow-xs" style="width: 36px; height: 36px; font-size: 0.8125rem; background-color: #eff6ff; color: #2563eb; border: 1px solid #bfdbfe;">
    ...
    @if(isset($relatedProducts) && $relatedProducts->count() > 0)
        <div class="tokobii-card p-4 shadow-sm">
            <h4 class="fw-bold text-slate-900 mb-3" style="font-size: 1.15rem;">Produk Terkait Lainnya</h4>
            <div class="row g-3 g-md-4">
                @foreach($relatedProducts as $rel)
                    <div class="col-6 col-md-3">
                        <div class="tokobii-product-card" onclick="if(!event.target.closest('button, form, a')) window.location='{{ route('customer.shop.show', $rel->slug) }}';">
                            <a href="{{ route('customer.shop.show', $rel->slug) }}" class="product-image-container position-relative bg-slate-100 d-flex align-items-center justify-content-center p-3 text-decoration-none" style="height: 150px;">
                                @if($rel->thumbnail)
