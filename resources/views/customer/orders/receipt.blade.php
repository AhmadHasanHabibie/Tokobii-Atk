...
<body class="bg-light py-4">
    ...
    <div class="container" style="max-width: 750px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 no-print">
            <a href="{{ route('customer.orders.show', $order) }}" class="btn btn-outline-secondary btn-sm fw-semibold">
        ...
        <div class="card border-0 shadow-lg rounded-3 receipt-card bg-white">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="row g-3 mb-4 small">
                    <div class="col-6">
                        <span class="text-secondary d-block">No. Invoice Order:</span>
                    ...
                    <table class="table table-bordered align-middle small mb-0">
                        ...
                        <tfoot>
                            <tr class="table-light">
                                <td colspan="5" class="text-end fw-bold fs-6">Grand Total Tagihan:</td>
